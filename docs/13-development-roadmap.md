...
- `bash -n scripts/data/*.sh`: PASS
- `make data-env`: PASS
- `make test-data-scripts`: PASS, 58 tests
- `make data-policy-check`: PASS
- `make ci-check`: PASS
- `make replay-paysim-sample-dry-run`: PASS, read=100 accepted=100 rejected=0
- app-api down connection check with `/tmp` report: PASS, connectionError=1
- dry-run dropped fields: `balanceFeatures=100`, `destinationAccountId=100`, `schemaVersion=100`, `source=100`
