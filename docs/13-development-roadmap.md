...
| V2 Phase 5 | Done | PaySim replay pipeline 구현 완료 | replay script, dry-run/actual replay targets, replay report, fixture/mock unittest, docs/blog | V2 Phase 6 Rule Engine V2 또는 replay result evaluation |
...
- Java Rule Engine V2는 구현하지 않았습니다.
- PaySim native `CASH_OUT`, `CASH_IN`, `DEBIT` actual replay는 Phase 6 이후 API DTO 확장 또는 Rule V2 contract와 함께 처리합니다.
...
| Step 7 | V2 Phase 6 | Rule Engine V2 초기 rule 구현 |
| Step 8 | V2 Phase 7 | Rule evaluation confusion matrix |
| Step 9 | V2 Phase 8 | Action Decision Engine |
| Step 10 | V2 Phase 9 | Fraud Case Management |
| Step 11 | V2 Phase 10 | visualization/evidence, README, docs, blog 정리 |
