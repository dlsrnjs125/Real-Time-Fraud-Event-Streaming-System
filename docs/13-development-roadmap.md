...
| V2 Phase 7 | PaySim Label-based Rule Evaluation | offline evaluation, confusion matrix, precision/recall/f1 coverage report | label sidecar는 평가에만 사용하고, Rule coverage table과 missed/false positive 예시 문서화 |
