...
| V2 Phase 7 CI-safe checks | `make verify-v2-phase7` | unittest output, data policy check output | data script tests pass, raw/full processed PaySim files excluded from Git | full evaluation input 없이 실행 가능 |
