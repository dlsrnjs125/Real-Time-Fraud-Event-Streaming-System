...
| V2 Phase 15 | final evidence closure | Phase 7~14 evidence map, implemented/local/manual/future separation, Decision Notes | `make final-check` | `docs/39-v2-final-evidence-closure.md` | Done | no new runtime feature |
