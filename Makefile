.PHONY: help build test test-common test-api test-consumer clean api consumer infra-up infra-down infra-ps infra-logs infra-config scripts-check topics smoke final-check
