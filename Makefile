...
k6-v3-phase7-historical-replay:
	...
	bash scripts/load_tests/prepare_v3_phase7_run.sh
	k6 -e V3_RUN_ID="$(V3_RUN_ID)" -e V3_COMMIT_SHA="$$(git rev-parse --short HEAD)$$(git diff --quiet || echo -dirty)" -e V3_WORKLOAD_MANIFEST=historical-replay-v1.json run load-test/k6/scenarios/v3-phase7-historical-replay.js
